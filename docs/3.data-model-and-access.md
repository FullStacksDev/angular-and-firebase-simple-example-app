...
<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/firebase/firestore.rules#L5-L17>
...
- For the `create` and `update` operations we ask Firestore to check the `userId` field of the data being written (the `request.resource.data.userId` field).
  - This ensures that a user can only create or update entries with their own `userId`.
...
<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/app/src/app/shared/models.ts#L15-L23>
...
<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/app/src/app/shared/models.ts#L25>
...
<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/app/src/app/logbook/data/db/entries.service.ts#L29>
...
<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/app/src/app/logbook/data/db/entries.service.ts#L31-L51>
...
>
> We don't do this in the simple example app but do explore this in the advanced example app.
...
>
> We touch on these aspects some more in the advanced example app.

We then have some very basic security rules to allow anyone to read but no one to write (from the client-side):

<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/firebase/database.rules.json#L1-L8>
...
<https://github.com/FullStacksDev/angular-and-firebase-simple-example-app/blob/bef7cbb5e8dd11b44d2180d3e8ce869cd0013f76/app/src/app/logbook/data/db/config.service.ts#L23-L25>
